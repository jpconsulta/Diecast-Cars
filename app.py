...
@app.route('/manufacturer/<carbrand>') #read_pets_by_pet_type so yung first val ng SQL siguro
...
def modify():
    ...
    if request.form["modify"] == "edit":
        ...
        return redirect(url_for('manufacturer', carbrand=request.form['car brand']))
...
def update():
    ...
    return redirect(url_for('car_name', diecast_id=request.form['diecast_id']))
